        ...
        <div className="mx-auto w-full max-w-md">
          ...
          {sent ? (
            <div className="text-center">
              ...
              <Link href="/user/login" className="btn-primary mt-8 inline-flex">Return to Student Login</Link>
            </div>
          ) : (
            <>
              <div>
                ...
                <p className="mt-2 text-sm text-muted">
                  Enter the email you used during enrollment and we&apos;ll send a reset link.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-5" noValidate>
                <div>
                  ...
                  <input
                    ...
                    className={cn('enterprise-input mt-1.5', fieldError && 'border-danger focus:border-danger focus:ring-danger/20')}
                  />
          ...
          <p className="mt-8 text-center text-sm text-muted">
            <Link href="/user/login" className="inline-flex items-center gap-1.5 font-medium text-primary hover:underline">
